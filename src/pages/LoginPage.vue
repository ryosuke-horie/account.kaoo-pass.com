...
<template>
    <div>
        <v-card class="mx-auto my-16 pa-12 pb-8 d-flex flex-column  justify-center" elevation="8" max-width="448"
            rounded="lg">
            <img class="mx-auto" alt="logo" src="../assets/logo_260x80.webp">
